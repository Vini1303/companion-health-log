...
import { Heart, Thermometer, Droplets, Activity, Pill, AlertTriangle, Clock } from "lucide-react";
...
const formatNumber = (value: number | undefined) =>
  typeof value === "number" && Number.isFinite(value) ? String(value) : "Não cadastrado";
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold break-words leading-tight">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold break-words leading-tight">{latestVital ? formatNumber(latestVital.heartRate) : "Não cadastrado"}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold break-words leading-tight">{latestVital ? `${formatNumber(latestVital.temperature)}°` : "Não cadastrado"}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold break-words leading-tight">{latestVital ? formatNumber(latestVital.glucose) : "Não cadastrado"}</p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Link to="/sinais-vitais" className="block">
        ...
        <Link to="/medicamentos" className="block">
          <Card className="cursor-pointer transition-colors hover:bg-muted/30">
            <CardHeader className="pb-2">
            ...
            <CardContent className="space-y-3">
              {medications.length === 0 ? (
                ...
                <p className="text-sm font-medium text-success">✓ Todos os medicamentos foram administrados!</p>
              ) : (
          ...
          <CardContent className="space-y-2">
            {unreadNotifications.length === 0 ? (
              ...
              unreadNotifications.slice(0, 4).map((notification) => (
                <div key={notification.id} className="flex items-center justify-between rounded-lg p-2 transition-colors hover:bg-muted/50">
